// ============================================
// Copyright (c) 2025-2026 Stock Analyzer. All rights reserved.
...
const CATEGORY_BY_TOOL = {
  ...
  get_portfolio_stress:     'risk',
  get_risk_contribution:    'risk',
  ...
  list_theses:           'thesis',
  get_thesis:            'thesis',
  evaluate_thesis_quality: 'thesis',
  ...
  // ── forecast (3, 2026-06-30) — 前瞻機率錐 / 校準帳本 / 盤前脈絡 ──
  get_price_forecast:       'forecast',
  get_forecast_calibration: 'forecast',
  get_preopen_context:      'forecast',
  // run_scenario 歸 risk（與 get_portfolio_stress 同族，代理問「壓測投組」會落在 risk）
  run_scenario:             'risk',
};
...
const CATEGORY_DESCRIPTIONS = {
  ...
  risk:         '系統性風險、VaR、投資組合最佳化、情境壓力傳播',
  forecast:     '個股價格機率錐（GBM）、前瞻校準戰績、台股盤前脈絡參考範圍',
